 ...
 * @author P.T. de Boer
 */
public abstract class TestVFS extends VTestCase
{
    ...
    public void testRootExists() throws Exception
    {
        ...
        VFSPath rootDir = getRemoteTestDir().getFileSystem().resolvePath(rootPath);
    ...
    public void testFSCreateAndDeleteFile() throws Exception
    {
        ...
        newFile = fs.resolvePath(fullpath);
        newFile.createFile(false);
    ...
    public void testCreateAndList3SubFiles() throws Exception
    {
        ...
        // create subdir:
        VFSPath file1 = newDir.resolvePath("subFile1");
        file1.createFile(false);
        VFSPath file2 = newDir.resolvePath("subFile2");
        file2.createFile(false);
        VFSPath file3 = newDir.resolvePath("subFile3");
        file3.createFile(false);

        VRL dirVrl = newDir.getVRL();
        VFSPath reDir = newDir.getFileSystem().resolvePath(dirVrl);
    ...
    public void testCreateAndList3SubDirs() throws Exception
    {
        ...
        subDir1.mkdir(false);
        VFSPath subDir2 = newDir.resolvePath("subDir2");
        subDir2.mkdir(false);
        VFSPath subDir3 = newDir.resolvePath("subDir3");
        subDir3.mkdir(false);
    ...
    public void testCreateAndDeleteRecursiveDir() throws Exception
    {
        ...
        VFSPath file1 = newDir.resolvePath("subFile1");
        file1.createFile(false);
        VFSPath file2 = newDir.resolvePath("subFile2s");
        file2.createFile(false);

        VFSPath subsubDir = subDir1.resolvePath("subsubDir1");
        subsubDir.mkdir(false);
        VFSPath subsubFile = subDir1.resolvePath("subsubsubFile1");
    ...
    public void testCreateAndDeleteFullDir() throws Exception
    {
        ...
        // check ./path !
        fullPath = getRemoteTestDir().resolvePathVRL("./" + nextFilename("testDirE"));
        ...
        newDir = getRemoteTestDir().resolvePath(pathStr);
    ...
    public void testCreateAndRenameDir() throws Exception
    {
        ...
        if (getTestRenames() == true)
        {
            ...
            VRL newVRL = parentDir.resolvePathVRL(newDirName);
            ...
            // re open/refetch.
            VFSPath targetDir = getRemoteTestDir().resolvePath(newDirName);
    ...
    public void testCreateAndRenameFile() throws Exception
    {
...

        {
            ...
            // fetch
            VFSPath renamedFile = getRemoteTestDir().resolvePath(newFileName);
    ...
    private void testRename(VFSPath parentDir, String orgFileName, String newFileName) throws Exception
    {
        ...
        VFSPath targetFile = parentDir.resolvePath(newFileName);
        ...
        VFSPath rerenamedFile = getRemoteTestDir().resolvePath(orgFileName);
    ...
    public void testSetGetSimpleContentsNewFile() throws Exception
    {
        ...
        // recreate file:
        newFile = getRemoteTestDir().resolvePath("testFile7a");
        // test2: big string
    ...
    public void testStreamRead() throws Exception
    {
        ...
        {
            localFile = localTempDir.resolvePath("test10MBStreamRead");
    ...
    public void testMultiStreamWritesCheckLengths() throws Exception
    {
        ...
        for (int i = 0; i < numTries; i++)
        {
            ...
            if (remoteFile instanceof VReplicatable)
            {
                ...
                VFSPath rep = remoteFile.getFileSystem().resolvePath(reps[0]);
    ...
    public void testRandomReadable() throws Exception
    {
        ...
        localFile = this.localTempDir.resolvePath("readBytesFile2");
        len = 1024 * 1024;
    ...
    public void testReadWriteRandomBytes() throws Exception
    {
        ...
        numRead = IOUtil.syncReadBytes(randomReader, 0, buffer2, 0, maxlen);
