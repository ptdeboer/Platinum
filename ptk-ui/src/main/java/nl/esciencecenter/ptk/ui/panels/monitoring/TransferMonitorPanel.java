...
public class TransferMonitorPanel extends JPanel {
    ...
    public void update(boolean finalUpdate) {
        ...
        String title = "?";
        // darn null pointers: 
        if ((this.vfsTransferInfo.getSource() != null)
                && (this.vfsTransferInfo.getDestination() != null))
            title = "Transfering:" + (this.vfsTransferInfo.getSource().getPath()) + " to "
                    + vfsTransferInfo.getDestination().getHost() + " (method="
                    + vfsTransferInfo.getActionType() + ")";
    ...
    public String getTotalTimeText() {
        String timestr = Presentation.createRelativeTimeString(monitorStats.getTotalTimeRunning(),
                false);
    ...
    public String getTotalProgressText() {
        ...
        String amountStr = sizeString(info.getTaskStats().done) + "B (of "
                + sizeString(info.getTaskStats().todo) + "B)";
