...
public interface FSInterface {
    ...
    public abstract FSPath resolvePath(java.net.URL url) throws FileURISyntaxException;
    ...
    public abstract BasicFileAttributes getBasicAttributes(FSPath fsPath, LinkOption... linkOptions) throws IOException;

    public abstract PosixFileAttributes getPosixAttributes(FSPath fsPath, LinkOption... linkOptions) throws IOException;

    public abstract FSPath mkdir(FSPath fsNode) throws IOException;

    public abstract FSPath mkdirs(FSPath fsNode) throws IOException;
