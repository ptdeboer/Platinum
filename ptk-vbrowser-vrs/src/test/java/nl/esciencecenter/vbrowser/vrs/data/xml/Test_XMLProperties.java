...
public class Test_XMLProperties {
    ...
    public void testXMLVRSProperties() throws Exception {
        ...
        testXMLVRSProperties("uriField", new java.net.URI(
    ...
    protected void compare(VRSProperties original, VRSProperties others,
        ...
        for (String key : orgKeys) {
            ...
            if (checkStringValuesOnly == false) {
                ...
                Assert.assertTrue("Field:" + key + " doesn't not match original value. original="
                        + org + ",other=" + other, org.equals(other));
            }
        }
    ...
    public void testVRLProperties() throws Exception {
        ...
        testXMLVRSProperties("vrlField", new VRL(
                "https://host.domain:8443/helloWorld?Query#Fragment"));
        testXMLVRSProperties("vrlField", new VRL(
                "https://host.domain:8443/helloWorld?Query#Fragment"));
