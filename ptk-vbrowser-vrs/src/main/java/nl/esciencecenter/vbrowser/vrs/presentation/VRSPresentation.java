...
public class VRSPresentation extends Presentation {
     ...
     *
     * @param scheme       - scheme name for example "file" or "http"
     * @param resourceType -
     * @param autocreate   - whether to autocreate the Presentation Object.
     ...
     *
     * @param scheme       - scheme name for example "file" or "http"
     * @param resourceType - VRS ResourceType for example "File" or "Dir".
     * @param presentation - actual Presentation.
     */
     ...
     *
     * @param VRL        - vrl
     * @param autocreate - whether to initialize a default Presentation object
     * @return
     */
