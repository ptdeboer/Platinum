...
public interface VResourceSystemFactory {
     ...
     */
    String createResourceSystemId(VRL vrl);

    ResourceConfigInfo updateResourceInfo(VRSContext context, ResourceConfigInfo resourceSystemInfo, VRL vrl);

    /**
     * Create new resource System. This system will be cached and re-used by the VRS if the
     * ResourceSystemID matches.
     */
    VResourceSystem createResourceSystemFor(VRSContext context, ResourceConfigInfo info, VRL vrl)
            throws VrsException;
