 ...
 */
public class ResourceSystemInfoNode extends InfoResourceNode implements VResourceConfigurable {

    protected ResourceSystemInfoNode(InfoRSPathNode parent, VRL logicalVRL, ResourceConfigInfo info) {
