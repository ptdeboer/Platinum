...
public class Test_Attribute
{
    ...
    /**
     * Unit test implementation: Explicit definition here to assert similar
     * implementation in Attribute.
     */
    ...
    public static void compareAttributeIntAndLongValues(int val1, int val2)
    {
        ...
        Assert.assertEquals("Integer.compare() and Long.compare() do not match (Max integer overflow?)!", intComp, longComp);
