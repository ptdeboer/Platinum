...
public class DnDData {
     ...
     */
    public static final String VBROWSER_VFSDIRECTORY_MIMETYPE = VBROWSER_VFS_MIMETYPE_PREFIX
            + "-directory";
    ...
    public static class VRLEntry implements Serializable {
        ...
        public String toString() {
            return "VRLEntry:[vrl=" + vrl + ", resourceType=" + resourceType + ", mimeType="
                    + mimeType + "]";
        }
    }
    ...
    public static DataFlavor flavorVFSPaths = new DataFlavor(VBROWSER_VFSPATH_MIMETYPE + ";class="
            + DnDUtil.mimeTypeClassName(VRLEntryList.class),
            "VFS Paths as as list of VRLs (List<VRL>)");
    ...
    /**
     * Check whether all of the Transferable data can be converted to one or more VRLs. This method
     * returns false if some data can not be converted to a VRL.
     */
    ...
    /**
     * Check whether all of the Transferable date can be converted to one or more VFSPaths. This
     * could be one ore more (remote) files. This method returns false if some data can not be
     * converted to a VFS Path.
     */
