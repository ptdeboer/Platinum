...
public class UIProperties extends VRSProperties
{
    ...
    {
        return getIntegerProperty(UIPropertyNames.MOUSE_SELECTION_BUTTON, default_mouse_selection_button);
    }

    public int getMouseActionButton()
    {
        return getIntegerProperty(UIPropertyNames.MOUSE_SELECTION_BUTTON, default_mouse_action_button);
    }
