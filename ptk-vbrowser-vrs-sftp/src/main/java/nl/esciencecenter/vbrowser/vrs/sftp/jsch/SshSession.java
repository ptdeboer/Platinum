...
public class SshSession implements AutoCloseable
{
    ...
    public SftpChannelInputStream createSftpInputStream(String remotePath) throws SftpException, JSchException
    {
    ...
    public SftpChannelOutputStream createSftpOutputStream(String remotePath, boolean append) throws SftpException, JSchException
    {
    ...
    protected void addUserIDFiles()
    {
        ...
        {
            logger.error("addUserIDFiles():Failed to read/acces config directory:{} => IOException:{}", configDir, e);
            return;
        }
    ...
    protected void addKnownHosts()
    {
        ...
        {
            logger.error("addKnownHosts():Failed to read/acces known hosts file:{}/{} => IOException:{}", configDir, knownHostsFile, e);
            return;
        }
        catch (JSchException e)
        {
            logger.error("addKnownHosts():Failed to add known hosts file:{}/{} => JSchException:{}", configDir, knownHostsFile, e);
            return;
        }
