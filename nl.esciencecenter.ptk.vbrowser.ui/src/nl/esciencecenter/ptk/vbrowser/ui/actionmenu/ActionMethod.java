...
/**
 * The action method is an enum, but enums can't be extended. So ActionMethods
 * are global (static) actions which are recognized by the ProxyBrowser and it's
 * classes. For extended actions: use DynamicAction. These can be defined by
 * subclasses and plugins and support arguments. 
 */
