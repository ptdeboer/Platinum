...
package nl.esciencecenter.ptk.ssl.ui;
...
/**
 * Swing accept/reject Certificate Dialog.
 */
public class CertificateJDialog extends javax.swing.JDialog {
    ...
    public CertificateJDialog(JFrame frame) {
        super(frame);
        initGUI();
    ...
    public static void main(String[] args) {
        ...
        CertificateJDialog inst = new CertificateJDialog(frame);
