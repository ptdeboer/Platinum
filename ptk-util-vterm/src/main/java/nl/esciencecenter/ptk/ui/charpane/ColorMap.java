...
public class ColorMap extends ArrayList<Color> {
    ...
    public static final ColorMap COLOR_MAP_WHITE_ON_BLACK = new ColorMap(Color.WHITE, Color.BLACK,
            colorMapWhite);

    public static final ColorMap COLOR_MAP_WHITE_SOFT = new ColorMap(Color.WHITE, Color.BLACK,
            colorMapWhiteSoft);

    public static final ColorMap COLOR_MAP_GREEN_ON_BLACK = new ColorMap(Color.BLACK, Color.GREEN,
            colorMapDarkGreen);

    public static final ColorMap COLOR_MAP_SHADED_GREEN = new ColorMap(Color.BLACK, Color.GREEN,
            colorMapShadedGreen);

    public static final ColorMap COLOR_MAP_PASTEL_PINK = new ColorMap(Color.PINK.brighter(),
            new Color(128, 64, 64), colorMapPastelPink);
    ...
    public static final String[] colorMapNames = { WHITE_CONTRAST, WHITE_SOFT, GREEN_CONTRAST,
