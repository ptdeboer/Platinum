...
/**
 * 
 * Implementation of most VT100 codes. With some vt102, and starting with xterm.
 * 
...
public class VT10xEmulator extends Emulator {
    ...
    public void sendTermSize() {
        byte bytes[] = { (byte) CTRL_ESC, '8', ';', (byte) ('0' + nr_rows / 100),
                (byte) ('0' + (nr_rows / 10) % 10), (byte) ('0' + nr_rows % 10), ';',
                (byte) ('0' + nr_columns / 100), (byte) ('0' + (nr_columns / 10) % 10),
                (byte) ('0' + nr_columns % 10), 't' };
    ...
    public void sendTermType() {
        byte bytes[] = { (byte) CTRL_ESC, '[', (byte) ('0'), // VT100
    ...
    private void handleSetFontStyle(ICharacterTerminal charTerm, int numIntegers, int[] integers) {
        int mode = 0;
    ...
    private void handleDecMode(ICharacterTerminal charTerm, int numIntegers, int[] integers,
            boolean value)
