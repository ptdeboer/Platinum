...
import static nl.esciencecenter.ptk.util.vterm.VT10xEmulatorDefs.Token.APPLICATION_KEYPAD;
import static nl.esciencecenter.ptk.util.vterm.VT10xEmulatorDefs.Token.BACKWARD_TABS;
...
import static nl.esciencecenter.ptk.util.vterm.VT10xEmulatorDefs.Token.CHARSET_G1_ALT_ROM_NORMAL;
import static nl.esciencecenter.ptk.util.vterm.VT10xEmulatorDefs.Token.CHARSET_G1_ALT_ROM_SPECIAL;
import static nl.esciencecenter.ptk.util.vterm.VT10xEmulatorDefs.Token.CHARSET_G1_GRAPHICS;
import static nl.esciencecenter.ptk.util.vterm.VT10xEmulatorDefs.Token.CHARSET_G1_UK;
import static nl.esciencecenter.ptk.util.vterm.VT10xEmulatorDefs.Token.CHARSET_G1_US;
import static nl.esciencecenter.ptk.util.vterm.VT10xEmulatorDefs.Token.CHARSET_GO_ALT_ROM_NORMAL;
import static nl.esciencecenter.ptk.util.vterm.VT10xEmulatorDefs.Token.CHARSET_GO_ALT_ROM_SPECIAL;
import static nl.esciencecenter.ptk.util.vterm.VT10xEmulatorDefs.Token.CHARSET_GO_GRAPHICS;
import static nl.esciencecenter.ptk.util.vterm.VT10xEmulatorDefs.Token.CHARSET_GO_UK;
import static nl.esciencecenter.ptk.util.vterm.VT10xEmulatorDefs.Token.CHARSET_GO_US;
import static nl.esciencecenter.ptk.util.vterm.VT10xEmulatorDefs.Token.CR;
import static nl.esciencecenter.ptk.util.vterm.VT10xEmulatorDefs.Token.CSI_SEQ_PREFIX;
import static nl.esciencecenter.ptk.util.vterm.VT10xEmulatorDefs.Token.DEC_RESETMODE;
import static nl.esciencecenter.ptk.util.vterm.VT10xEmulatorDefs.Token.DEC_SCREEN_ALIGNMENT;
import static nl.esciencecenter.ptk.util.vterm.VT10xEmulatorDefs.Token.DEC_SETMODE;
import static nl.esciencecenter.ptk.util.vterm.VT10xEmulatorDefs.Token.DELETE_LINES;
import static nl.esciencecenter.ptk.util.vterm.VT10xEmulatorDefs.Token.DEL_CHAR;
import static nl.esciencecenter.ptk.util.vterm.VT10xEmulatorDefs.Token.DEVICE_STATUS;
import static nl.esciencecenter.ptk.util.vterm.VT10xEmulatorDefs.Token.DOWN;
...
import static nl.esciencecenter.ptk.util.vterm.VT10xEmulatorDefs.Token.ERASE_CHARS;
...
import static nl.esciencecenter.ptk.util.vterm.VT10xEmulatorDefs.Token.EXIT_VT52_MODE;
import static nl.esciencecenter.ptk.util.vterm.VT10xEmulatorDefs.Token.FF;
import static nl.esciencecenter.ptk.util.vterm.VT10xEmulatorDefs.Token.FORWARD_TABS;
import static nl.esciencecenter.ptk.util.vterm.VT10xEmulatorDefs.Token.HT;
import static nl.esciencecenter.ptk.util.vterm.VT10xEmulatorDefs.Token.IDENTIFY_AS_VT102;
import static nl.esciencecenter.ptk.util.vterm.VT10xEmulatorDefs.Token.INDEX;
import static nl.esciencecenter.ptk.util.vterm.VT10xEmulatorDefs.Token.INSERT_BLANK_CHARS;
import static nl.esciencecenter.ptk.util.vterm.VT10xEmulatorDefs.Token.INSERT_LINES;
import static nl.esciencecenter.ptk.util.vterm.VT10xEmulatorDefs.Token.LEFT;
import static nl.esciencecenter.ptk.util.vterm.VT10xEmulatorDefs.Token.LF;
import static nl.esciencecenter.ptk.util.vterm.VT10xEmulatorDefs.Token.LINE_ERASE;
import static nl.esciencecenter.ptk.util.vterm.VT10xEmulatorDefs.Token.NEXT_LINE;
import static nl.esciencecenter.ptk.util.vterm.VT10xEmulatorDefs.Token.NUMERIC_KEYPAD;
import static nl.esciencecenter.ptk.util.vterm.VT10xEmulatorDefs.Token.PRECEDING_LINE;
import static nl.esciencecenter.ptk.util.vterm.VT10xEmulatorDefs.Token.PRIVDEC_SEQ_PREFIX;
import static nl.esciencecenter.ptk.util.vterm.VT10xEmulatorDefs.Token.REQ_IDENTIFY;
import static nl.esciencecenter.ptk.util.vterm.VT10xEmulatorDefs.Token.REQ_IDENTIFY2;
import static nl.esciencecenter.ptk.util.vterm.VT10xEmulatorDefs.Token.REQ_SECONDARY_DA_PREFIX;
import static nl.esciencecenter.ptk.util.vterm.VT10xEmulatorDefs.Token.RESET_MODE;
import static nl.esciencecenter.ptk.util.vterm.VT10xEmulatorDefs.Token.RESTORE_CURSOR;
import static nl.esciencecenter.ptk.util.vterm.VT10xEmulatorDefs.Token.REVERSE_INDEX;
import static nl.esciencecenter.ptk.util.vterm.VT10xEmulatorDefs.Token.RIGHT;
import static nl.esciencecenter.ptk.util.vterm.VT10xEmulatorDefs.Token.SAVE_CURSOR;
import static nl.esciencecenter.ptk.util.vterm.VT10xEmulatorDefs.Token.SCREEN_ERASE;
import static nl.esciencecenter.ptk.util.vterm.VT10xEmulatorDefs.Token.SCROLL_DOWN_OR_MOUSETRACK;
import static nl.esciencecenter.ptk.util.vterm.VT10xEmulatorDefs.Token.SCROLL_UP;
import static nl.esciencecenter.ptk.util.vterm.VT10xEmulatorDefs.Token.SET_COLUMN;
import static nl.esciencecenter.ptk.util.vterm.VT10xEmulatorDefs.Token.SET_CURSOR;
import static nl.esciencecenter.ptk.util.vterm.VT10xEmulatorDefs.Token.SET_FONT_STYLE;
import static nl.esciencecenter.ptk.util.vterm.VT10xEmulatorDefs.Token.SET_MODE;
import static nl.esciencecenter.ptk.util.vterm.VT10xEmulatorDefs.Token.SET_REGION;
import static nl.esciencecenter.ptk.util.vterm.VT10xEmulatorDefs.Token.SET_ROW;
import static nl.esciencecenter.ptk.util.vterm.VT10xEmulatorDefs.Token.SUB;
import static nl.esciencecenter.ptk.util.vterm.VT10xEmulatorDefs.Token.TAB_SET;
import static nl.esciencecenter.ptk.util.vterm.VT10xEmulatorDefs.Token.UP;
import static nl.esciencecenter.ptk.util.vterm.VT10xEmulatorDefs.Token.VT;
import static nl.esciencecenter.ptk.util.vterm.VT10xEmulatorDefs.Token.XGRAPHMODE;
...
public class VT10xEmulatorDefs {
    ...
    */
    ...
    public static enum Token implements IToken {
        ...
        // === 
        // screen manupilation:
        SET_REGION, SET_CURSOR, SET_CURSORX, SET_FONT_STYLE, SET_MODE, RESET_MODE, LINE_ERASE,
        SCREEN_ERASE,
        SET_COLUMN,
        DEL_CHAR,
        ERASE_CHARS,
        ...
        // Dec Privates ?
        // ======================
        DEC_SETMODE, DEC_RESETMODE, CHARSET_GO_UK, CHARSET_GO_US, CHARSET_GO_GRAPHICS,
        CHARSET_GO_ALT_ROM_NORMAL, CHARSET_GO_ALT_ROM_SPECIAL, CHARSET_G1_UK, CHARSET_G1_US,
        CHARSET_G1_GRAPHICS, CHARSET_G1_ALT_ROM_NORMAL, CHARSET_G1_ALT_ROM_SPECIAL,
        DEC_SCREEN_ALIGNMENT,
        //
        EXIT_VT52_MODE, REQ_UNKNOWN, // Request for device -> not implemented or unknown. 
    ...
    public static enum TokenOption {
        OPTION_PARSE_INTEGERS, OPTION_PARSE_GRAPHMODE;
    }

    /**
     * Simple token table. Store TOKEN as string together whith char sequence (as string). This list
     * is searched linear so that the first match is used.
     */
    ...
    /**
     * Match symbolic (AWT) Key Code String to actual Control Sequence to send. Optional prefixed
     * with TERM Type:
     */
    public static String keyMappings[][] = {
            //Default key mapping. Applies for most VT100/XTerms 

            { CTRL_ESC + "OP", "F1" }, { CTRL_ESC + "OQ", "F2" }, { CTRL_ESC + "OR", "F3" },
            { CTRL_ESC + "OS", "F4" }, { CTRL_ESC + "Ot", "F5" }, { CTRL_ESC + "Ou", "F6" },
            { CTRL_ESC + "Ov", "F7" }, { CTRL_ESC + "OI", "F8" }, { CTRL_ESC + "Ow", "F9" },
            { CTRL_ESC + "Ox", "F10" },

            { CTRL_ESC + "[5~", "PAGE_UP" }, { CTRL_ESC + "[6~", "PAGE_DOWN" },

            { CTRL_ESC + "[2~", "INSERT" }, { CTRL_ESC + "[3~", "DELETE" },

            { CTRL_ESC + "[5~", "PAGE_UP" }, { CTRL_ESC + "[6~", "PAGE_DOWN" },

            { CTRL_ESC + "[2~", "INSERT" }, { CTRL_ESC + "[3~", "DELETE" },

            { CTRL_CR + "", "ENTER" }, { CTRL_BS + "", "BACKSPACE" },
            { CTRL_HT + "", "TAB" },
            ...
            { CTRL_ESC + "[A", "XTERM_" + UP }, { CTRL_ESC + "[B", "XTERM_" + DOWN },
            { CTRL_ESC + "[C", "XTERM_" + RIGHT }, { CTRL_ESC + "[D", "XTERM_" + LEFT },

            { CTRL_ESC + "OA", "VT100_" + UP }, { CTRL_ESC + "OB", "VT100_" + DOWN },
            { CTRL_ESC + "OC", "VT100_" + RIGHT }, { CTRL_ESC + "OD", "VT100_" + LEFT },

            { CTRL_ESC + "OA", "APP_" + UP }, { CTRL_ESC + "OB", "APP_" + DOWN },
            { CTRL_ESC + "OC", "APP_" + RIGHT }, { CTRL_ESC + "OD", "APP_" + LEFT },

            { CTRL_ESC + "A", "VT52_" + UP }, { CTRL_ESC + "B", "VT52_" + DOWN },
            { CTRL_ESC + "C", "VT52_" + RIGHT }, { CTRL_ESC + "D", "VT52_" + LEFT },

            { CTRL_ESC + "P", "VT52_F1" }, { CTRL_ESC + "Q", "VT52_F2" },
            { CTRL_ESC + "R", "VT52_F3" }, { CTRL_ESC + "S", "VT52_F4" },
